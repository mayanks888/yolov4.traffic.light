...
class Detect():
    def __init__(self, args_,bblabel):
        ...
        self.used_sensor= ['CAM_FRONT', 'CAM_FRONT_RIGHT', 'CAM_BACK_RIGHT', 'CAM_BACK', 'CAM_BACK_LEFT', 'CAM_FRONT_LEFT']
...
def main(args=None):
    ...
    df.to_csv('yolov4_nuscene_prediction_all_folder.csv', index=False)
