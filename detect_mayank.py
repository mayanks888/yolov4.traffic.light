...
if __name__ == '__main__':
    ...
    parser.add_argument('--names', type=str, default='/mayank_script/data_format_yolo/bdd100k_single_tl.names', help='*.names path')
    parser.add_argument('--weights', type=str, default='/home/mayank_s/Downloads/yolov4_tl_weight/yolov4-custom_tl_5000.weights', help='weights path')
    # parser.add_argument('--weights', type=str, default='/home/mayank_s/Downloads/darknet_weight_yolov3/backup/yolov3_tl_5000.weights', help='weights path')
    parser.add_argument('--source', type=str, default='/home/mayank_s/datasets/farminton/new_cropped_Demo/mayank_1', help='source')  # input file/folder, 0 for webcam
